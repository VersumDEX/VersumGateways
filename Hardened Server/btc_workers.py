...
if __name__ == "__main__":
    btc = Server("http://127.0.0.1:"+bport, auth=(buser,\
                                                bpassword))
    versum = Savoir(muser, \
                    mpassword, \
                    "localhost", mport, \
                    mchainname)
    url = publicserver+"/btc/"
